            ...
            <div className="w-full bg-[#26383C] rounded-[10px] py-10 px-10">
                <div className="flex flex-col gap-8">
                    ...
                    <div className="grid grid-cols-3 grid-rows-1 gap-8">
                        ...
                        <span className="col-start-2 col-span-2 text-red-600 text-xl font-extrabold  self-center text-right ">
                    ...
                    <div className="grid grid-cols-3 grid-rows-1 gap-8">
                        ...
                        <div className="col-start-2 col-span-2 text-red-600 self-center text-right flex flex-col ">
                            ...
                            <span className="text-[15px]">{readMoney((TamTinh.TienTamTinh).toString())}</span>
                        </div>
                    </div>
