...
const UserInfo = () => {
    ...
    return (
        <div className="">
            <div className="sticky top-0 bg-[#404040]/[70%] px-7 py-9 w-auto min-h-screen max-h-max  grid grid-rows-7">
                <div className="row-start-1 flex items-center mb-[22px]">
                    <img src={logo} alt="" className="w-[72px] mr-2" />
                    <span className="bg-gradient-to-r from-[#9747FF] via-[#6493F0] to-[#31E1E1] inline-block text-transparent bg-clip-text text-[50px] select-none mr-7">BBANK</span>
                </div>
                <div className="row-start-2 row-end-8 flex flex-col space-y-7">
                    <div className="flex flex-col text-center rounded-[20px] bg-gradient-to-b from-[#2C4044]/[50%] to-[#2C4044]">
                    ...
                    <div className="flex flex-col px-5 pt-5 rounded-[20px] bg-gradient-to-b from-[#2C4044]/[50%] to-[#2C4044]">
                    ...
                    <div className="flex flex-row text-center rounded-[20px] bg-gradient-to-b from-[#2C4044]/[50%] to-[#2C4044] py-6 pl-5 hover:bg-gradient-to-t hover:from-[#2C4044]/[50%] hover:to-[#2C4044]">
                    ...
                    <div className="flex flex-col space-y-6 text-center rounded-[20px] bg-gradient-to-b from-[#2C4044]/[50%] to-[#2C4044] py-6 px-5 hover:bg-gradient-to-t hover:from-[#2C4044]/[50%] hover:to-[#2C4044] w-auto">
