...
import Stepper from '../../components/EDepositTStepper/Stepper';
import Checking from "../../components/EDepositTStepper/steps/Checking";
import StepperControl from '../../components/EDepositTStepper/StepperControl';
import Initialization from "../../components/EDepositTStepper/steps/Initialization";
import Confirmation from "../../components/EDepositTStepper/steps/Confirmation";
import Reject from "../../components/EDepositTStepper/steps/Reject";
import Result from "../../components/EDepositTStepper/steps/Result";
import uitPattern from '../../assets/icons/uitPattern.svg'
import { useState, useRef, useEffect } from "react";
import { useNavigate } from "react-router-dom";
import { useSelector } from "react-redux";

const EDepositSavingT = () => {
                        ...
                        <div className="w-1/2 self-center">
                            ...
                            <div className="w-full">
                                <h1 className="mt-20 text-[40px]
                                    ...
                                    Lập phiếu gửi tiết kiệm truyền thống
                                </h1>
                                <div className="2xl:mt-[23px] text-[20px]
                                    ...
                                    <p>&nbsp;&gt;&nbsp;</p>
                                    <p className="text-[#72BF00] hover:cursor-auto"> Lập phiếu gửi tiết kiệm truyền thống</p>
                                </div>
                            </div>
...
export default EDepositSavingT;