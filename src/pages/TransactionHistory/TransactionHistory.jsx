...
import Stepper from '../../components/TransactionHistoryStepper/Stepper';
import StepperControl from '../../components/TransactionHistoryStepper/StepperControl';
import Initialization from "../../components/TransactionHistoryStepper/steps/Initialization";
import Reject from "../../components/TransactionHistoryStepper/steps/Reject";
import Result from "../../components/TransactionHistoryStepper/steps/Result";
...
const TransactionHistory = () => {
    ...
    const isTransactionSuccess = useSelector((state) => state.getTransHis.isTransactionSuccess)
    ...
    const createTransaction = async () => {
        try {
            await initializationRef.current.createTransaction();
        ...
        <div className="grid grid-cols-11 grid-flow-col-dense ">
            ...
            <div className="col-end-12 col-span-9 flex flex-col">
                ...
                <div className="w-auto overflow-auto flex flex-col">
                    ...
                    <div className="bg-[#39464A]/[90%] h-auto flex flex-col pt-[72px] z-10 min-h-screen">
                            ...
                            <div className="w-full">
                                ...
                                <div className="2xl:mt-[23px] text-[20px]
                                    ...
                                    <span onClick={() => navigate('../home/account')}
                                        className="hover:cursor-pointer relative inline before:bg-[#72BF00] before:absolute before:-bottom-[2px] before:block before:h-[2px] before:w-full before:origin-bottom-right before:scale-x-0 before:transition before:duration-300 before:ease-in-out hover:before:origin-bottom-left hover:before:scale-x-100"> Tài khoản </span>
                                    <p>&nbsp;&gt;&nbsp;</p>
                                    <p className="text-[#72BF00] hover:cursor-auto"> Lịch sử giao dịch </p>
                                </div>
                            </div>
