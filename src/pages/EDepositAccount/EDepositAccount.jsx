...
import Authenticity from "../../components/EDepositAccountStepper/steps/Authenticity";
                        ...
                        <div className="w-1/2 self-center">
                            ...
                            <div className="w-full">
                                ...
                                <div className="2xl:mt-[23px] text-[20px]
                                    ...
                                    <p>&nbsp;&gt;&nbsp;</p>
                                    <p className="text-[#72BF00] hover:cursor-auto"> Lập phiếu chuyển tiền mặt </p>
                                </div>
                            </div>
