...
const Home = () => {
    ...
    const chuyenTienGroup = [
        { icon: ic_ChuyenTien, content: 'Chuyển tiền trong BBank' },
        { icon: ic_ChuyenTienMat, content: 'Chuyển tiền mặt' },
    ]
                        ...
                        <div className="flex flex-wrap mb-20 px-36 gap-11 items-center  ">
                            {
                                fastFeatures.map((item, index) => (
                                    <img key={index} src={item} alt="" className="h-[134px] min-w-[185px] self-center transition ease-in-out delay-150 hover:-translate-y-1 hover:drop-shadow-2xl-green duration-300" />
                                ))
                            }
                            ...
                            <div className="flex flex-wrap mb-20 px-36 gap-11 items-center mt-20 ">
                                {
                                    chuyenTienGroup.map((item, index) => (
                                        <div className="grid grid-rows-2  ">
                                            <img key={index} src={item.icon} alt="" className=" bg-[#6B7E84] max-h-[134px] max-w-[134px] transition ease-in-out hover:bg-[#82898B] rounded-[20px] p-10 duration-300 m-auto " />
