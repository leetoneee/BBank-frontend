                ...
                <div className="sticky h-20 top-0 z-10">
                    <div className="w-full bg-blue-800 flex justify-center">
                        <div className="flex items-center mb-[22px]">
                            <span className="bg-gradient-to-r from-[#9747FF] via-[#6493F0] to-[#31E1E1] inline-block text-transparent bg-clip-text text-[50px] select-none font-bold">CHỨC NĂNG</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="h-auto flex flex-col min-h-screen  no-scrollbar">
                    ...
                    <table className="w-full text-left text-gray-500 table">
                        <thead className="text-[23px] text-gray-700 uppercase bg-gray-200 sticky top-[170px] z-10 ">
                            <tr>
                                <th className="p-4">Mã chức năng</th>
                                <th>Tên chức năng</th>
                                <th>Url</th>
                                <th>Action</th>
                            </tr>
                                ...
                                filteredData.map((d, i) => (
                                    <tr key={i} className="hover:bg-gray-400 border-b">
                                        ...
                                        <td>
                                            ...
                                            <button onClick={() => handleDelete(d.MaChucNang)} className="bg-red-500 hover:bg-red-700 text-white py-1 px-3 rounded text-lg ml-2">
                                                Xóa
                                            </button>
                                        </td>
                                    </tr>
